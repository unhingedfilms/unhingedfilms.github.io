...
$(function () {
  ...
  $('#mini_sidebar_setting').on('change', function () {
    ...
    $('.collapse-btn i').toggleClass('fas fa-arrow-left fas fa-arrow-right');
  });
  ...
  // sidebar collapse icon chage
  $('.navbar-nav .collapse-btn').click(function () {
  ...
  $(".layout-color input:radio").change(function () {
    if ($(this).val() == "1") {
      ...
      $(".choose-theme li[title|='default']").addClass("active");
